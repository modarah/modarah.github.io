...
const Datenschutz = () => {
  return (
    <div className="datenschutz" id="datenschutz">
      ...
      <p>
        Modar Abo Hassoun<br/>Geyerstraße 3
        <br/>04317 Leipzig
      </p>
      E-Mail-Adresse:{" "}
      <p>
        <a href="mailto:modar.abohassoun@gmail.com">
          modar.abohassoun@gmail.com
        </a>
      </p>
